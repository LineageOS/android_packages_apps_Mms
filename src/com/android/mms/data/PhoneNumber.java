...
public class PhoneNumber {
    ...
    private PhoneNumber(Context context, Cursor c) {
        ...
        mId = c.getLong(_ID);
        mNumber = c.getString(PHONE_NUMBER);
        mType = c.getInt(PHONE_TYPE);
        mLabel = c.getString(PHONE_LABEL);
        mName = c.getString(PHONE_DISPLAY_NAME);
        mContactId = c.getLong(PHONE_CONTACT_ID);
        mGroups = new ArrayList<Group>();
        mIsDefault = (c.getInt(PHONE_IS_SUPER_PRIMARY) != 0) ? true : false;
        mIsFirst = true;
    ...
    public static ArrayList<PhoneNumber> getPhoneNumbers(Context context) {
        ...
        final String selection = Phone.NUMBER + " NOT NULL";

        final String sort = Phone.DISPLAY_NAME + ", "
        ...
        while (cursor.moveToNext()) {
            PhoneNumber recipient = new PhoneNumber(context, cursor);
    ...
    public static PhoneNumber get(Context context, String number) {
        ...
        final String[] projection = new String[] {
            ...
            final String selection = Phone.NUMBER + "=" + number;
