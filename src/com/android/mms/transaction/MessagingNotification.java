...
public class MessagingNotification {
    ...
    private static void updateNotification(
        ...
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        boolean privacyMode = sp.getBoolean(MessagingPreferenceActivity.NOTIFICATION_PRIVACY_MODE_ENABLED, true);
        if (isNew) {
        	if (!privacyMode) noti.setTicker(mostRecentNotification.mTicker);
        	else noti.setTicker(context.getString(R.string.notification_ticker_privacy_mode));
        }
