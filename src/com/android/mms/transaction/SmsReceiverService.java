...
//        }
    ...
    private boolean isQueuedMessageCancel(Uri msgUri) {
        ...
        boolean enableDelaySendMessage = prefs != null ? prefs.getBoolean(
                MessagingPreferenceActivity.DELAY_SEND_ENABLED, false) : false;
            ...
            try {
                ...
                while (countDown >= 0 && !isCancelSending) {
                    ...
                    if (countDown > 0) {
                        ...
                        isCancelSending = end - start < SmsReceiverService.TIMMER_DURATION ? true
                                : false;
