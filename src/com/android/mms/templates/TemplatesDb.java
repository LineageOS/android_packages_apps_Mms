...
public class TemplatesDb {
	...
	return mDb.query(TemplateMetaData.TABLE_NAME, null, null, null, null,
		null, null);
    }

    public String[] getAllTemplatesText() {
	Cursor c = mDb.query(TemplateMetaData.TABLE_NAME, null, null, null,
		null, null, null);
	...
	try {
	    cursor = mDb.query(TemplateMetaData.TABLE_NAME,
		    new String[] { TemplateMetaData.TEMPLATE_TEXT },
		    TemplateMetaData.TEMPLATE_ID + "=?",
	...
	mDb.update(TemplateMetaData.TABLE_NAME, cv,
		TemplateMetaData.TEMPLATE_ID + " = ?",
    ...
    private static final String TEMPLATE_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
	    ...
	    + TemplateMetaData.TEMPLATE_TEXT + " text not null);";
