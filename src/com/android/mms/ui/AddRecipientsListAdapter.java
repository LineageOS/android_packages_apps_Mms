...
public class AddRecipientsListAdapter extends ArrayAdapter<RecipientsListLoader.Result>
        implements SectionIndexer, AbsListView.RecyclerListener {
    private final LayoutInflater mInflater;
    private String[] mSections;
    private int[] mPositions;

    public AddRecipientsListAdapter(Context context,
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            String name = item.phoneNumber.getName();
            String letter = name.substring(0, 1).toUpperCase();
            if (!TextUtils.equals(letter, lastLetter)) {
                sections.add(letter);
                positions.add(i);
                lastLetter = letter;
            }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            view = (AddRecipientsListItem) mInflater.inflate(
    ...
    public void unbindView(View view) {
        if (view instanceof AddRecipientsListItem) {
            AddRecipientsListItem arli = (AddRecipientsListItem) view;
            arli.unbind();
        }
    }
