...
//    }
    ...
    private void sendMessage(boolean bCheckEcmMode) {
        ...
        if (!mSendingMessage && mRecipientsEditor != null) {
            final Runnable onRun = new Runnable() {
                public void run() {
                    // send can change the recipients. Make sure we remove the listeners
                    // first and then add them back once the recipient list has settled.
                    removeRecipientsListeners();
            ...
            if (phoneGoggles != null) {
                try {
                    phoneGoggles.invoke(null, this,
                            ...
                            mRecipientsEditor.getNumbers().toArray(new String[0]),
                            onRun, onCancel,
