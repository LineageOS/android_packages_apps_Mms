            ...
            switch (item.getItemId()) {
                ...
                case MENU_RESEND_MESSAGE: {
                    if (msgItem.isSms()){
                        ...
                        PduBody body = PduBodyCache.getPduBody(ComposeMessageActivity.this,ContentUris.withAppendedId(Mms.CONTENT_URI, msgId));
                        for(int i = 0; i < body.getPartsNum(); i++) {
                            mWorkingMessage.setAttachment(msgItem.mAttachmentType, body.getPart(i).getDataUri(), true);
                        }
