...
public class MessagingPreferenceActivity extends PreferenceActivity
    ...
    // Privacy mode
    public static final String NOTIFICATION_PRIVACY_MODE_ENABLED = "pref_key_enable_privacy_mode";
    ...
    private void loadPrefs() {
        ...
        mEnablePrivacyModePref = (CheckBoxPreference) findPreference(NOTIFICATION_PRIVACY_MODE_ENABLED);
    ...
    public static boolean getPrivacyModeEnabled(Context context) {
        ...
        boolean quickMessageEnabled =
            prefs.getBoolean(MessagingPreferenceActivity.NOTIFICATION_PRIVACY_MODE_ENABLED, false);
    ...
    public static void enablePrivacyMode(boolean enabled, Context context) {
        ...
        SharedPreferences.Editor editor =
            PreferenceManager.getDefaultSharedPreferences(context).edit();
        editor.putBoolean(MessagingPreferenceActivity.NOTIFICATION_PRIVACY_MODE_ENABLED, enabled);
        editor.apply();
    }
