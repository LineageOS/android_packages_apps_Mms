...
public class MessagingPreferenceActivity extends PreferenceActivity
    ...
    protected void onResume() {
         ...
         * activity, we have to reload it whenever we resume.
         */
    ...
    private void loadPrefs() {
        ...
        mUnicodeStrippingEntries = getResources().getTextArray(
                R.array.pref_unicode_stripping_entries);

        // Get the MMS retrieval settings. Defaults to enabled with roaming
        // disabled
    ...
    private void restoreDefaultPreferences() {
         ...
         * message recycler) will be turned off by default. However, we really
         * want the default to be turned on. Because all the prefs are cleared,
         * that'll cause:
         * ConversationList.runOneTimeStorageLimitCheckForLegacyMessages to get
         * executed the next time the user runs the Messaging app and it will
         * either turn on the setting by default, or if the user is over the
         * limits, encourage them to turn on the setting manually.
         */
    }
    ...
    private void setMessagePreferences() {
        ...
        if (!MmsConfig.getMmsEnabled()) {
            ...
            // If the phone's SIM doesn't know it's own number, disable group
            // mms.
        ...
        // If needed, migrate vibration setting from the previous tri-state
        // setting stored in
        // NOTIFICATION_VIBRATE_WHEN to the boolean setting stored in
        ...
        if (sharedPreferences.contains(NOTIFICATION_VIBRATE_WHEN)) {
            ...
            prefsEditor.remove(NOTIFICATION_VIBRATE_WHEN); // remove obsolete
                                                           // setting
            prefsEditor.apply();
        ...
        String gestureSensitivity = String.valueOf(sharedPreferences.getInt(
                GESTURE_SENSITIVITY_VALUE, 3));
        ...
        int unicodeStripping = sharedPreferences.getInt(UNICODE_STRIPPING_VALUE,
                UNICODE_STRIPPING_LEAVE_INTACT);
        ...
        // read in text size values, set summary
    ...
    private void setEnabledNotificationsPref() {
         ...
         * Read the current value and set the checkbox to match.
         */
    ...
    private void setEnabledPrivacyModePref() {
        /*
         * The "enable privacy mode" setting is really stored in our own prefs.
         * Read the current value and set the checkbox to match.
         */
        ...
        /*
         * Enable/Disable the "enable quickmessage" setting according to the
         * "enable privacy mode" setting state
         */
        mEnableQuickMessagePref.setEnabled(!isPrivacyModeEnabled);

        /*
         * Enable/Disable the "enable dark theme" setting according to the
         * "enable privacy mode" setting state
         */
    ...
    private void setEnabledQuickMessagePref() {
        /*
         * The "enable quickmessage" setting is really stored in our own prefs.
         * Read the current value and set the checkbox to match.
         */
    ...
    private void setEnabledQmLockscreenPref() {
        /*
         * The "enable quickmessage on lock screen " setting is really stored in
         * our own prefs. Read the current value and set the checkbox to match.
         */
    ...
    private void setEnabledQmCloseAllPref() {
        /*
         * The "enable close all" setting is really stored in our own prefs.
         * Read the current value and set the checkbox to match.
         */
    ...
    private void setEnabledQmDarkThemePref() {
        /*
         * The "Use dark theme" setting is really stored in our own prefs. Read
         * the current value and set the checkbox to match.
         */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                 ...
                 * Take them back from wherever they came from.
                 */
                finish();
                return true;
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mSmsLimitPref) {
            ...
            // Update the actual "enable private mode" value that is stored in
            // secure settings.
            ...
            Settings.System.putInt(getContentResolver(),
                    Settings.System.MMS_AUTO_RETRIEVAL_ON_ROAMING,
    ...
    /**
     * Update the text size summary according to the changed preference and it's
     * new value.
     * 
