...
public class QuickMessage extends Activity {
    ...
    private QuickMessageContent mCurrentQm;
    private int mCurrentQmIndex = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // We are set to wake when unlocked, set the window manager parameters
        if (!MessagingPreferenceActivity.getQmLockscreenEnabled(mContext)) {
            getWindow().addFlags(LayoutParams.FLAG_SHOW_WHEN_LOCKED
                    | LayoutParams.FLAG_TURN_SCREEN_ON | LayoutParams.FLAG_DIM_BEHIND);
        ...
        mCloseButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCloseClosesAll || numMessages == 1) {
                    ...
                    EditText editView = (EditText) findViewById(mCurrentQmIndex+99999);
                    if (editView != null) {
    ...
    private void parseIntent(Intent intent, boolean newMessage) {
        ...
        if (nm != null) {
            ...
            if (newMessage) {
                ...
                mMessagePager.setCurrentItem(mMessageList.size()-1);
            }
        }
    }
    ...
    private void markCurrentMessageRead() {
        Conversation con = Conversation.get(getApplicationContext(), mCurrentQm.getThreadId(), true);
        if (con != null) {
            con.markAsRead();
        }
    }
    ...
    private void saveReplyText() {
        // Store the reply text for the current message if it exists
        if (mCurrentQm != null) {
            EditText editView = (EditText) findViewById(mCurrentQmIndex+99999);
            if (editView != null) {
                mCurrentQm.setReplyText(editView.getText().toString());
            }
        }
    }
    ...
    private class MessagePagerAdapter extends PagerAdapter
        ...
        public Object instantiateItem(View collection, int position) {
            ...
            // Load the main views
            final EditText qmReplyText = (EditText) layout.findViewById(R.id.embedded_text_editor);
            qmReplyText.setId(position+99999);
            ...
            if (qm != null) {
                ...
                qmReplyText.setOnEditorActionListener(new OnEditorActionListener() {
                    ...
                    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                        ...
                        if (actionId == EditorInfo.IME_ACTION_SEND) {
                            if (v != null) {
                                sendQuickMessage(v.getText().toString());
                            }
                            return true;
                        }
                        return true;
                ...
                qmSendButton.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        sendQuickMessage(qmReplyText.getText().toString());
