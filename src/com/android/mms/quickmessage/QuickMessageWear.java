...
public class QuickMessageWear extends Activity {
    ...
    private void parseIntent(Bundle extras) {
        ...
        if (message.length() <= 160) {
            ...
            SmsMessageSender smsMessageSender = new SmsMessageSender(getBaseContext(), dest, message.toString(), tId);
            try {
            ...
            Toast.makeText(mContext, R.string.too_many_chars + " to " + mContactName, Toast.LENGTH_LONG).show();
        }
